              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    Expanded(
                      child: Text(
                        'میتونی عکس فرزند دومت رو اینجا آپلود کنی',
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    obscureText: false,
                    decoration: InputDecoration(
                      labelText: 'سن فرزند دوم',
                      labelStyle:
                          FlutterFlowTheme.of(context).bodyMedium.override(
                                fontFamily: 'Outfit',
                                color: FlutterFlowTheme.of(context).grayLight,
                              ),
                      hintText: 'عدد وارد کنید',
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
                            fontFamily: 'Outfit',
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    obscureText: false,
                    decoration: InputDecoration(
                      labelText: 'کد ملی فرزند دومتون',
                      labelStyle:
                          FlutterFlowTheme.of(context).bodyMedium.override(
                                fontFamily: 'Outfit',
                                color: FlutterFlowTheme.of(context).grayLight,
                              ),
                      hintText: 'کدملی ش رو اینجا وارد کنید',
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
                            fontFamily: 'Outfit',
                ...
                Padding(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'شماره تلفن رو اینجا وارد کن',
                      hintStyle: FlutterFlowTheme.of(context)
                          .bodyMedium
                          .override(
                            fontFamily: 'Outfit',
