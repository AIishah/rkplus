...
import 'zaban_description_model.dart';
export 'zaban_description_model.dart';

class ZabanDescriptionWidget extends StatefulWidget {
  const ZabanDescriptionWidget({Key? key}) : super(key: key);

  @override
  _ZabanDescriptionWidgetState createState() => _ZabanDescriptionWidgetState();
}

class _ZabanDescriptionWidgetState extends State<ZabanDescriptionWidget>
    with TickerProviderStateMixin {
  late ZabanDescriptionModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ZabanDescriptionModel());
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Text(
                          'از آنجا که مهد هوشمند رنگین کمان کرمان همواره با آموزش پیشرفته خود شناخته می شود و با توجه به اینکه در سال جدید سازمان ملی تعلیم و ترییت کودک محدودیت 4 ساعت آموزش در روز را وضع نموده است، از این رو تعدادی از آموزش های فوق برنامه مون رو برای نوآموزان عزیز مهد رنگین کمان کرمان به صورت آنلاین و با بالاترین کیفیت و جدید ترین متد های روز دنیا با پرده کروماکی ضبط کردیم و دوشنبه هر هفته در اپلیکیشن قرار میدهیم.\nزبان انگلیسی رو هم توی مهد داریم و هم فوق برنامه آنلاین ، کلاس اینجا پیشرفته تر و اصولی تره! ',
                          style:
