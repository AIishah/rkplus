import '/components/error_page3/error_page3_widget.dart';
import '/components/rahnamaee/rahnamaee_widget.dart';
...
import 'pinpage3_model.dart';
export 'pinpage3_model.dart';

class Pinpage3Widget extends StatefulWidget {
  const Pinpage3Widget({Key? key}) : super(key: key);

  @override
  _Pinpage3WidgetState createState() => _Pinpage3WidgetState();
}

class _Pinpage3WidgetState extends State<Pinpage3Widget> {
  late Pinpage3Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Pinpage3Model());
  }
              ...
              children: [
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      if (_model.pinCodeController!.text == '931121') {
                        context.pushNamed('HiddenPage3');
                      } else {
                        await showModalBottomSheet(
                          isScrollControlled: true,
                          backgroundColor: Colors.transparent,
